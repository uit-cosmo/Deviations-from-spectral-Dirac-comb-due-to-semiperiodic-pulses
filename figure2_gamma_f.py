...
model.set_custom_forcing_generator(ForcingGammaDistribution(beta=1000))
...
model.set_custom_forcing_generator(ForcingGammaDistribution(beta=100))
...
model.set_custom_forcing_generator(ForcingGammaDistribution(beta=10))
