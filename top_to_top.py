...
from fit_function_RB_model import create_fit_RB, create_fit_RB_fixed_amp
import cosmoplots
...
intervals_start = [
    10000
]  # , 18600, 21200, 28000, 30500, 33000, 37800, 40500, 45400, 52600]
...
for i in range(len(intervals_start)):
    ...
    time_series_fit, symbols, duration_time, forcing = create_fit_RB_fixed_amp(
        "2e6", f, dt, Pxx, ts_interval, time
    )
